function ajax_alacarte()
{
	...
	xmlhttp.open("GET","http://client.attuneinfocom.com/gtpl_drupal/gtpl/ajax/alacart.php",true);
	xmlhttp.send();
	return false;
}
function form_submit(nid,checkbox_id){
	...
	xmlhttp.open("GET","http://client.attuneinfocom.com/gtpl_drupal/gtpl/ajax/alacart.php?nid="+nid+"&checkbox_id="+checkbox_id+"&checkbox="+checkbox,true);
	xmlhttp.send();
}
...
function ajax_bb_selection(tid,id){
	...
	xmlhttp.open("GET","http://client.attuneinfocom.com/gtpl_drupal/gtpl/ajax/selected_bb_plan.php?tid="+tid+"&id="+id,true);
	xmlhttp.send();
}
function ajax_bb_more_info(tid,id){
	...
	xmlhttp.open("GET","http://client.attuneinfocom.com/gtpl_drupal/gtpl/ajax/selected_bb_info.php?tid="+tid+"&id="+id,true);
	xmlhttp.send();
}
function redirect_function(url,kolkata){
	...
	if(city == "75"){
		...
		window.open(url+"/node/476", "_self");
	}else if(city == "72"){
...
function redirect_page_bb_function(){
	...
	xmlhttp.open("GET","http://client.attuneinfocom.com/gtpl_drupal/gtpl/ajax/selected_city_session.php?city="+city,true);
	xmlhttp.send();
...
function check_all(nid,json){
	...
	xmlhttp.open("GET","http://client.attuneinfocom.com/gtpl_drupal/gtpl/ajax/alacart.php?nid="+nid+"&checkbox="+channels.checked+"&all_channels=1"+"&channel_array="+array_channel,true);
	xmlhttp.send();*/
}
